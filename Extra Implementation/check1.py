...
regions have different variances.
This is motivated from section 6 of David Hogg's Data Analysis Recipes: 
...
def make_data(n_data_points, xmin, xmax, n_segments, sigy_min, sigy_max, parameters):
    """
    Create data with the given model and add noise.
    """
...
def run_mcmc(x, y, NUM, segments, nwalkers=500, n_burn=500, n_prod=2000):
    """
